...
public interface ISort {
     ...
     * 时间复杂度：O(N2) 　　稳定性：稳定
     */
    List<Integer> bubbleSort(List<Integer> sortedNums);
     ...
     * 时间复杂度：O(N2) 　　稳定性：不稳定
     */
    List<Integer> selectionSort(List<Integer> sortedNums);
     ...
     */
    List<Integer> quickSort(List<Integer> sortedNums);
     ...
     * 时间复杂度：O(N2) 　　稳定性：稳定
     */
    List<Integer> insertionSort(List<Integer> sortedNums);
     ...
     */
    List<Integer> shellSort(List<Integer> sortedNums);
     ...
     * 时间复杂度：O(x*N) 　　稳定性：稳定
     */
    List<Integer> bucketSort(List<Integer> sortedNums);
     ...
     * 时间复杂度：O(x*N) 　　稳定性：稳定
     */
    List<Integer> radixSort(List<Integer> sortedNums);
     ...
     */
    List<Integer> mergeSort(List<Integer> sortedNums);
    ...
    * 时间复杂度：O(NlogN) 　　稳定性：不稳定
    */
    List<Integer> heapSort(List<Integer> sortedNums);
